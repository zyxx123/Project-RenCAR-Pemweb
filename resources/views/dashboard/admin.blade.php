            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-sm font-bold text-slate-500 uppercase tracking-wider mt-1">Total Customers</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-sm font-bold text-slate-500 uppercase tracking-wider mt-1">Successful Bookings</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-sm font-bold text-slate-500 uppercase tracking-wider mt-1">Total Revenue</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-slate-100">
                <div class="p-8 text-slate-900">
                    <div class="flex justify-between items-center mb-8 border-b border-slate-100 pb-4">
                        <h3 class="text-xl font-bold text-slate-800">Manage Bookings</h3>
                    ...
                    @if($bookings->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <p class="text-slate-500 text-lg">No bookings found in the system.</p>
                        </div>
                    @else
                        <div class="overflow-x-auto border border-slate-200 rounded-xl">
                            <table class="min-w-full divide-y divide-slate-200">
                                <thead class="bg-slate-50">
                                    <tr>
                                        <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Booking Code</th>
                                        ...
                                        <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Total Price</th>
                                                ...
                                                @if($booking->status === 'waiting_verification')
                                                    ...
                                                    <div class="flex space-x-3 border-t border-slate-100 pt-3">
                                                        <form action="{{ route('admin.booking.verify', $booking->id) }}" method="POST">
                                                            @csrf
                                                            <button type="submit" class="text-white font-bold bg-emerald-500 hover:bg-emerald-600 px-3 py-1.5 rounded-lg shadow-sm transition-colors">Verify</button>
                                                        </form>
                                                        <form action="{{ route('admin.booking.reject', $booking->id) }}" method="POST">
                                                            @csrf
                                                            <button type="submit" class="text-white font-bold bg-red-500 hover:bg-red-600 px-3 py-1.5 rounded-lg shadow-sm transition-colors">Reject</button>
                                                        </form>
                                                    </div>
                                                @endif
                                            </td>
